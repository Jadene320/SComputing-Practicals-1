...
```{r}
#Generate 1000 random values from a tdist
t_dist <- rt(1000,1)
tdist_quant <- quantile(t_dist, probs = seq(0,1,0.01))


norm_dist <- rnorm(1000)
norm_dist_quants <- quantile(norm_dist, probs = seq(0,1,0.01))
#Calculate quantiles for normal distribution, plot against tdistribution
#How to find quantiles 
plot(tdist_quant, norm_dist, main = "QQ-plot",
