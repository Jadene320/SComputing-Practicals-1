...
upper <- apply(norm_quants,1, quantile, probs = 0.025) #apply quantile over all the rows of norm quants and return the 2.5th percentile
lower <- apply(norm_quants,1, quantile, probs = 0.975)
norm_med <- apply(norm_quants,1,quantile, probs = 0.50) #get the median aswell

#Calculate quantiles for normal distr, plot against tdistr
